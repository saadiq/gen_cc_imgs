...
def create_country_code_sticker(country_code, size=(1200, 800), bg_color='white', text_color='black', font_name='Arial Bold'):
    ...
    border_width = int(10 * scale_factor * (size[0] / 300))  # Scale up the border width based on the new size
